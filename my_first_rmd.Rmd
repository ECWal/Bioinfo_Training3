...
### The Survey
In the survey[^1] respondents were asked to rate 11 different approaches to improve reproducibility in science. Below is the list in order by the most highly rated:
...
ghp_29teScJEv2mXnCKKybzyJZyVywlyeP2nGUci